...
lx,_=violinplot_from_histogram(lx,lpx,lxrange,color='C0',alpha=0.5,side='left',marker=5,showmeans=False) 
lx,_=violinplot_from_histogram(lx,lpx,lxrange,color='C1',alpha=0.5,side='right',marker=4,showmeans=False)
#lx.axis('off')
...
bx.set_ylabel(r'$\mathrm{Median}[\Psi(f_{k+1}^*-f^*_k|f^*_k)]$')
